                        ...
                        <form class="pl-3 pr-3" action="#" id="user_form">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="number" required=""
                                       id="south_african_id" name="south_african_id" placeholder="Enter South African Id Number">
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   @php
                                     $data = array('English','Spanish','hindi','Venda','Zulu');
                                    @endphp
                                <div class="form-group col-md-6">
                                    <label for="language">Select Language</label>
                                    <select class="form-control" aria-label="Default select example" name="language" id="lang">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" data-role="tagsinput" name="interest[]" required=""
                                           id="interest" placeholder="Enter your interest">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="button_div text-center">
                                <button type="button" class="btn btn-info btn-center" data-toggle="modal" data-target="#addModal" id="add_user_model">+ Add New User</button>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="default_order" class="table table-striped table-bordered display no-wrap"
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$user->surname}}</td>
                                        <td>
                                            <button type="button" class="btn btn-info fas fa-edit user_edit_cl" user-id="{{$user->id}}"></button>
                                            <button type="button" class="btn btn-danger delete_user_cl  fas fa-trash-alt"
                                                    data-toggle="modal" data-target="#delete-modal" user-id="{{$user->id}}"></button>
                                        </td>
                                    </tr>
